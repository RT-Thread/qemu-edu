...
def cargo_build_component_staticlib(rust_dir, target, features, debug, rustflags=None):
    ...
    build_root = os.path.join(
        os.path.abspath(os.path.join(rust_dir, os.pardir, os.pardir)), 
...
def build_example_component(cwd, has_func, rtconfig, clean_func=None, build_root=None):
    """
    ...
    Args:
        ...
        clean_func: Optional function to clean build artifacts
    ...
    # Check if cleaning
    if clean_func and build_root:
        clean_func(build_root)
